...
This repo contains my personal dotfiles and are heavily based on [addy](hhttps://github.com/addyosmani/dotfiles) and [paul](https://github.com/paulirish/dotfiles/) and [mathias](https://github.com/mathiasbynens/dotfiles/)'s.
